          ...
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            <div className="grid grid-cols-2 gap-4" data-aos="fade-left">
              {[
                ...
                <div key={i} className={`p-6 rounded-xl bg-gradient-to-br ${c.bg} ${c.mt ? 'mt-8' : ''}`}>
                  {c.icon}
        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={i} className="p-6 text-center bg-white rounded-xl shadow-md dark:bg-gray-900 hover:shadow-lg hover:-translate-y-1 transition-all" data-aos="fade-up" data-aos-delay={i * 100}>
