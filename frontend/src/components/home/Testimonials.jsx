    ...
    return (<section className="py-16 bg-white dark:bg-gray-900">
      <div className="container px-4 mx-auto">
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-3xl font-bold text-gray-900 dark:text-white" data-aos="fade-up">
            What Our Customers Say
          </h2>
          <p className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-400" data-aos="fade-up" data-aos-delay="100">
            Don't just take our word for it – here's what customers think about our rental service
          </p>
        </div>
        
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3" data-aos="fade-up" data-aos-delay="200">
          {testimonials.map((testimonial) => (<div key={testimonial.id} className="p-6 rounded-lg shadow-md bg-gray-50 dark:bg-gray-800">
              <div className="flex items-center mb-4">
                <img src={testimonial.avatar} alt={testimonial.name} className="object-cover w-12 h-12 mr-4 rounded-full"/>
                <div>
              ...
              <div className="flex mb-3">
                {[...Array(5)].map((_, i) => (<Star key={i} className={`h-4 w-4 ${i < testimonial.rating
