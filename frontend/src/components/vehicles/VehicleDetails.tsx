...
import { 
  Users, Fuel, Gauge, Star, Calendar, ArrowLeft, 
  ChevronLeft, ChevronRight, Shield, BarChart, Car,
  Bike, AlertCircle
} from 'lucide-react';
...
const VehicleDetails: React.FC = () => {
  ...
  const [selectedRentalType, setSelectedRentalType] = useState<'hourly' | 'daily' | 'weekly'>('daily');
  ...
  return (
    <div className="container px-4 py-12 mx-auto">
      <button 
        onClick={() => navigate(-1)} 
        className="flex items-center mb-6 text-blue-600 transition-colors dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
      >
        ...
        <div>
          <div className="relative mb-4 overflow-hidden bg-gray-100 rounded-lg dark:bg-gray-800 aspect-w-16 aspect-h-10">
            ...
            <button 
              ...
              className="absolute p-2 text-gray-800 transition-colors transform -translate-y-1/2 rounded-full left-2 top-1/2 bg-white/70 hover:bg-white"
            ...
            <button 
              ...
              className="absolute p-2 text-gray-800 transition-colors transform -translate-y-1/2 rounded-full right-2 top-1/2 bg-white/70 hover:bg-white"
        ...
        <div>
          ...
          <div className="pt-6 mb-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              <button
                onClick={() => setSelectedRentalType('hourly')}
                className={`p-3 text-center rounded-md border transition-colors ${
                  selectedRentalType === 'hourly'
