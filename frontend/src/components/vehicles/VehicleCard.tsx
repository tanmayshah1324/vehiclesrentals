...
const VehicleCard: React.FC<VehicleCardProps> = ({ vehicle }) => {
  ...
  return (
    <div 
      className="overflow-hidden transition-transform duration-300 bg-white rounded-lg shadow-md dark:bg-gray-800 hover:shadow-lg hover:-translate-y-1"
      data-aos="fade-up"
    >
      ...
      <div className="p-4">
        ...
        <Link 
          to={availability ? `/booking/${id}` : '#'}
          className={`w-full text-center block py-2 px-4 rounded font-medium ${
            availability 
              ? 'bg-blue-600 hover:bg-blue-700 text-white' 
              : 'bg-gray-300 dark:bg-gray-700 text-gray-500 dark:text-gray-400 cursor-not-allowed'
          }`}
          onClick={(e) => !availability && e.preventDefault()}
        >
